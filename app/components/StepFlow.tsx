        ...
        <div className="relative mb-6 md:mb-14 py-4 md:py-6 px-4 md:px-0  rounded-lg z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                {steps.map((step, index) => (
                    <motion.div
                        key={step.title}
                        className={`${step.color} p-4 md:p-6 rounded-lg relative z-10 ${activeStep === index ? `ring-2 ring-offset-2 ring-offset-${step.iconClassName} ring-${step.iconClassName}` : ""}`}
                    ...
                    >
                        <div className="flex flex-col items-center text-center">
                            <div className="mb-3">
                                <step.icon size={24} className={`text-${step.iconClassName}`} />
                            </div>
